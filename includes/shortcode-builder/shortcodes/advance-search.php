...
$params_arr['result_page'] = array(
    ...
    'desc' => esc_html__('Select Search Result Page.', 'wp-jobsearch'),
    'options' => $all_page
);
...
$params_arr['serch_btn_txt'] = array(
    'std' => '',
    'type' => 'text',
    'label' => esc_html__('Search Button Text', 'wp-jobsearch'),
    'desc' => esc_html__('Select Search Button Text.', 'wp-jobsearch'),
);
$params_arr['serch_txt_color'] = array(
    'std' => '',
    'classes' => 'jobsearch-bk-color',
    'type' => 'text',
    'label' => esc_html__('Search Button Text Color', 'wp-jobsearch'),
    'desc' => esc_html__('Select Search Button Text Color.', 'wp-jobsearch'),
);
$params_arr['serch_bg_color'] = array(
    'std' => '',
    'classes' => 'jobsearch-bk-color',
    'type' => 'text',
    'label' => esc_html__('Search Button Background Color', 'wp-jobsearch'),
    'desc' => esc_html__('Select Search Button Background Color.', 'wp-jobsearch'),
);
$params_arr['serch_hov_color'] = array(
    'std' => '',
    'classes' => 'jobsearch-bk-color',
    'type' => 'text',
    'label' => esc_html__('Search Button Hover Color', 'wp-jobsearch'),
    'desc' => esc_html__('Select Search Button Hover Color.', 'wp-jobsearch'),
);
