 ...
 * do_action('jobsearch_candidate_contact_form', $user_data, $post_id);
 * 
 */
if (!class_exists('jobsearch_candidate_contact_form_template')) {

    class jobsearch_candidate_contact_form_template {
        ...
        public function __construct() {
            ...
            add_action('init', array($this, 'jobsearch_candidate_contact_form_template_init'), 1, 0);
            add_filter('jobsearch_candidate_contact_form_filter', array($this, 'jobsearch_candidate_contact_form_filter_callback'), 1, 4);
            add_filter('jobsearch_email_template_settings', array($this, 'template_settings_callback'), 12, 1);
            add_action('jobsearch_candidate_contact_form', array($this, 'jobsearch_candidate_contact_form_callback'), 10, 5);
        }

        public function jobsearch_candidate_contact_form_template_init() {
            $this->user = array();
            $this->user_name = '';
            $this->user_email = '';
            $this->user_phone = '';
            ...
            $this->group = 'job';
            $this->type = 'candidate_contact_form';
            $this->filter = 'candidate_contact_form';
            $this->email_template_db_id = 'candidate_contact_form';
            $this->switch_label = esc_html__('Candidate Contact Form', 'wp-jobsearch');
            ...
            $default_content = apply_filters('jobsearch_candidate_contact_form_filter', $default_content, 'html', 'candidate-contact-form', 'email-templates');
            $this->default_content = $default_content;
            $this->email_template_prefix = 'candidate_contact_form';
            $this->codes = array(
        ...
        public function jobsearch_candidate_contact_form_callback($user = '', $user_name = '', $user_email = '', $user_phone = '', $user_msg = '') {
            ...
            if (isset($template['switch']) && $template['switch'] == 1) {
                ...
                jobsearch_candidate_contact_form_template::$is_email_sent1 = $this->is_email_sent;
                return true;
            }
        }
        ...
        public function jobsearch_candidate_contact_form_filter_callback($html, $slug = '', $name = '', $ext_template = '') {
            ob_start();
            $html = '';
            $template = '';
            if ($ext_template != '') {
        ...
        public function template_settings_callback($email_template_options) {
            ...
            $email_template_options['candidate_contact_form']['rand'] = $this->rand;
            $email_template_options['candidate_contact_form']['email_template_prefix'] = $this->email_template_prefix;
            $email_template_options['candidate_contact_form']['default_var'] = $this->default_var;
    ...
    new jobsearch_candidate_contact_form_template();
}