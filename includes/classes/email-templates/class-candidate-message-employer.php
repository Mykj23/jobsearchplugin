...
if (!class_exists('jobsearch_candidate_message_employer_template')) {
    ...
    class jobsearch_candidate_message_employer_template {
        ...
        public function __construct() {
            ...
            add_action('jobsearch_candidate_message_employer', array($this, 'jobsearch_candidate_message_employer_callback'), 10, 4);
        }
        ...
        public function jobsearch_candidate_message_employer_template_init() {
            ...
            $this->switch_label = esc_html__('Job Inquery to Employer', 'wp-jobsearch');
            $this->default_subject = esc_html__('New job inquery submitted', 'wp-jobsearch');
        ...
        public function jobsearch_candidate_message_employer_callback($user = '', $job_id = '', $user_submitted_subject = '', $user_submitted_content = '') {
            ...
            if (isset($template['switch']) && $template['switch'] == 1) {
                ...
                $subject = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : __('Email Recieved', 'wp-jobsearch');
