...
class Jobsearch_JobFilterHTML {
                ...
                <div class="jobsearch-checkbox-toggle" style="display: <?php echo ($date_filter_collapse == 'yes' ? 'none' : 'block') ?>;"> 
                    <ul class="jobsearch-checkbox"> 
                        <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                            ...
                            ?>
                            <input id="lasthour<?php echo absint($rand); ?>" type="radio" name="posted" <?php if ($posted == 'lasthour') echo 'checked="checked"'; ?> onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);" value="lasthour" />
                        ...
                        <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                            ...
                            ?>
                            <input id="last24<?php echo absint($rand); ?>" type="radio" name="posted" <?php if ($posted == 'last24') echo 'checked="checked"'; ?> onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);" value="last24" />
                        ...
                        <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                            ...
                            ?>
                            <input id="7days<?php echo absint($rand); ?>" type="radio" name="posted" <?php if ($posted == '7days') echo 'checked="checked"'; ?> onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);" value="7days" />
                        ...
                        <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                            ...
                            ?>
                            <input id="14days<?php echo absint($rand); ?>" type="radio" name="posted" <?php if ($posted == '14days') echo 'checked="checked"'; ?> onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);" value="14days" />
                        ...
                        <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                            ...
                            ?>
                            <input id="30days<?php echo absint($rand); ?>" type="radio" name="posted" <?php if ($posted == '30days') echo 'checked="checked"'; ?> onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);" value="30days" />
                        ...
                        <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                            ...
                            ?>
                            <input id="all<?php echo absint($rand); ?>" type="radio" name="posted" <?php if ($posted == 'all' || $posted == '') echo 'checked="checked"'; ?> onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);" value="all" />
    ...
    static function jobsearch_job_filter_jobtype_box_html_callback($html, $global_rand_id, $args_count, $left_filter_count_switch, $sh_atts) {
        ...
        <div class="jobsearch-filter-responsive-wrap">
            <div class="jobsearch-search-filter-wrap jobsearch-search-filter-toggle <?php echo ($type_filter_collapse == 'yes' ? 'jobsearch-remove-padding' : '') ?>">
                <h2><a href="javascript:void(0);" class="jobsearch-click-btn"><?php echo esc_html__('Job Type', 'wp-jobsearch'); ?></a></h2> 
                <div class="jobsearch-checkbox-toggle" style="display: <?php echo ($type_filter_collapse == 'yes' ? 'none' : 'block') ?>;"> 
                    <?php
                        ...
                        if ($all_job_type != '') {
                            ...
                            foreach ($all_job_type as $job_typeitem) {
                                ...
                                <li<?php echo ($left_filter_count_switch != 'yes' ? ' class="no-filter-counts"' : '') ?>>
                                    ...
                                    ?>
                                    <label for="<?php echo force_balance_tags('job_type_' . $job_type_flag) ?>"><span></span><?php echo force_balance_tags($job_typeitem->name); ?></label>
                                    <?php if ($left_filter_count_switch == 'yes') { ?>
        ...
        foreach ($terms as $term) {
            if ($parent_id == $term->parent) {
                ...
                if (function_exists('icl_object_id')) {
                    ...
                    if ($job_type_count_post == 0 && isset($trans_able_options['job']) && $trans_able_options['job'] == '2') {
    ...
    static function jobsearch_job_filter_joblocation_box_html_callback($html, $global_rand_id, $args_count, $left_filter_count_switch, $sh_atts) {
        global $jobsearch_form_fields, $job_location_flag, $loc_counter;
        $job_type_name = 'job-location';
        ...
        <div class="jobsearch-filter-responsive-wrap">
            <div class="jobsearch-search-filter-wrap jobsearch-search-filter-toggle <?php echo ($loc_filter_collapse == 'yes' ? 'jobsearch-remove-padding' : '') ?>">
                ...
                <?php
                if ($job_loc_filter_view == 'input') {
                    ?>
                    <div class="jobsearch-checkbox-toggle" style="display: <?php echo ($loc_filter_collapse == 'yes' ? 'none' : 'block') ?>;">   
                        <ul class="jobsearch-checkbox">
                            <li>
                                <input type="text" name="location" placeholder="<?php echo esc_html__('Search by Location', 'wp-jobsearch'); ?>" value="<?php echo ($job_type) ?>" onchange="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>)">
                            </li>
                        </ul>
                    </div>
                    <?php
            ...
            <div class="jobsearch-search-filter-wrap jobsearch-search-filter-toggle <?php echo ($sec_filter_collapse == 'yes' ? 'jobsearch-remove-padding' : '') ?>">
                ...
                <div class="jobsearch-checkbox-toggle" style="display: <?php echo ($sec_filter_collapse == 'yes' ? 'none' : 'block') ?>;"> 
                    ...
                    if ($sector != '') {
                        ...
                        ?>
                        <ul class="jobsearch-checkbox">
                            <li><a href="#" onclick="jobsearch_job_content_load(<?php echo absint($global_rand_id); ?>);"><?php echo esc_html__('View all sector', 'wp-jobsearch'); ?></a></li><li>&nbsp;</li>
                        </ul>
                        <?php
                    }
                    $sector_args = array(
