...
// hook things up
    ...
    public function add_banner_ad_to_list() {
        ...
        if ($banner_title == '') {
            $msg = __('Please add banner title.', 'wp-jobsearch');
        ...
        if ($banner_type == 'adsense') {
            ...
            if ($banner_adsense_code == '') {
                $msg = __('Please add adsense code.', 'wp-jobsearch');
                echo json_encode(array('html' => '', 'error' => '1', 'msg' => $msg));
                die;
            }
        } else {
            $banner_counts = '0';
            if ($banner_img == '') {
                $msg = __('Please add banner image.', 'wp-jobsearch');
                echo json_encode(array('html' => '', 'error' => '1', 'msg' => $msg));
                die;
            }
            if ($banner_img_url == '') {
                $msg = __('Please add banner image url.', 'wp-jobsearch');
                echo json_encode(array('html' => '', 'error' => '1', 'msg' => $msg));
                die;
            }
        }
        ...
        <div class="ad-item">
            <ul>
                ...
                <li class="ad-code"><?php echo ('[jobsearch_ad code="' . $rand_num . '"]') ?></li>
                <li>
            ...
            <div class="action-update-con">
                ...
                <div class="ad-banner-field-con ads-select-field">
                    ...
                    <div class="field-value">
                        <select class="jobsearch-ad-type-select" name="<?php echo ($option_name) . '[banner_type][]' ?>" data-id="<?php echo ($rand_num) ?>">
                ...
                <div id="ad-banner-img-field-<?php echo ($rand_num) ?>" class="ad-banner-field-con ads-input-field" style="display: <?php echo ($banner_type == 'image' ? 'block' : 'none') ?>;">
                    <div class="field-label"><?php esc_html_e('Banner Image', 'wp-jobsearch') ?></div>
                    <div class="field-value">
                        <div id="ad-image-<?php echo ($rand_num) ?>-box" class="jobsearch-browse-med-image" style="display: <?php echo ($banner_img != '' ? 'block' : 'none') ?>;">
                            <a class="jobsearch-rem-media-b" data-id="ad-image-<?php echo ($rand_num) ?>"><i class="dashicons dashicons-no-alt"></i></a>
                            <img id="ad-image-<?php echo ($rand_num) ?>-img" src="<?php echo ($banner_img) ?>" alt="">
                        </div>
                        <input type="hidden" id="ad-image-<?php echo ($rand_num) ?>" name="<?php echo ($option_name) . '[banner_image][]' ?>" value="<?php echo ($banner_img) ?>">
                        <input type="button" class="jobsearch-upload-media jobsearch-bk-btn" name="ad-image-<?php echo ($rand_num) ?>" value="<?php esc_html_e('Browse', 'wp-jobsearch') ?>"> 
                    </div>
                </div>
                <div id="ad-banner-img-url-field-<?php echo ($rand_num) ?>" class="ad-banner-field-con ads-input-field" style="display: <?php echo ($banner_type == 'image' ? 'block' : 'none') ?>;">
                ...
                <div id="ad-banner-url-target-field-<?php echo ($rand_num) ?>" class="ad-banner-field-con ads-input-field" style="display: <?php echo ($banner_type == 'image' ? 'block' : 'none') ?>;">
                ...
                <div id="ad-banner-adsense-field-<?php echo ($rand_num) ?>" class="ad-banner-field-con ads-textarea-field" style="display: <?php echo ($banner_type == 'adsense' ? 'block' : 'none') ?>;">
        ...
        echo json_encode(array('html' => $html, 'error' => '0', 'msg' => __('Banner added to list.', 'wp-jobsearch')));
        die;
    }
    ...
    public function add_ads_group_to_list() {
        ...
        if ($group_title == '') {
            $msg = __('Please add Group title.', 'wp-jobsearch');
            echo json_encode(array('html' => '', 'error' => '1', 'msg' => $msg));
            die;
        }
        ...
        echo json_encode(array('html' => $html, 'error' => '0', 'msg' => __('Group added to list.', 'wp-jobsearch')));
        die;
    }
        ...
        if ($ads_management_switch == 'on') {
            ...
            $new_element = array(
                ...
                array(
                    ...
                    'description' => esc_html__("Repeat ad banner after specific number of jobs Or display add once.", "wp-jobsearch"),
                    'group' => esc_html__("Ad Banner Settings", "wp-jobsearch"),
                ),
                array(
                    'type' => 'dropdown',
        ...
        if ($ads_management_switch == 'on') {
            ...
            $new_element = array(
                ...
                'job_ad_banners_rep' => array(
                    ...
                    'desc' => esc_html__('Repeat ad banner after specific number of jobs Or display add once.', 'wp-jobsearch'),
                    'options' => array(
                        'yes' => esc_html__('Yes', 'wp-jobsearch'),
                        'no' => esc_html__('No', 'wp-jobsearch'),
                    )
            ...
            if (isset($banners_value['banner_group']) && !empty($banners_value['banner_group'])) {
                ...
                if (!empty($banner_codes_array)) {
                    ...
                    foreach ($banner_codes_array as $banner_codes_arr) {
                        ...
                        do_shortcode('[jobsearch_ad code="' . $banner_codes_arr . '"]');
                        if ($wrapper_tag != '') {
                            echo ('</' . $wrapper_tag . '>');
                        }
    ...
    public function ad_banner_shortcode($atts = array()) {
        ...
        if (isset($all_ad_banners['banner_code']) && is_array($all_ad_banners['banner_code'])) {
            ...
            ?>
            <div class="jobsearch-ad-banner-con">
                <?php
                if ($banner_type == 'adsense') {
