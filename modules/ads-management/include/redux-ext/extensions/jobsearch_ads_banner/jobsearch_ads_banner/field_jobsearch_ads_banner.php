        ...
        public function render() {
            ...
            <div id="ads-management-sec-<?php echo ($field_random) ?>" class="ads_management_con">
                <div class="banner-groups-sec">
                    ...
                    <div class="ad-banner-fields-sec">
                        <div class="ad-banner-field-con ads-input-field">
                            <div class="field-label"><?php esc_html_e('Group Title', 'wp-jobsearch') ?></div>
                            <div class="field-value">
                                <input type="text" id="group-title">
                            </div>
                        </div>
                        <div class="ad-banner-field-con ads-select-field">
                        ...
                        <div class="ad-banner-field-con ads-submit-field">
                            <div class="submit-btn">
                                <a href="javascript:void(0);" class="add-ad-group-to-list"><?php esc_html_e('Add Group', 'wp-jobsearch') ?></a>
                                <span class="loader-box"></span>
                            </div>
                        </div>
                        <div class="message-box"></div>
                    </div>
                    <div class="ad-groups-list-sec">
                ...
                <div class="ad-banner-seprator"></div>
                <div class="banner-all-ads-sec">
                    ...
                    <div class="ad-banner-fields-sec">
                        ...
                        <div id="ad-banner-img-field" class="ad-banner-field-con ads-input-field">
                            <div class="field-label"><?php esc_html_e('Banner Image', 'wp-jobsearch') ?></div>
                            <div class="field-value">
                                <div id="ad-image-box" class="jobsearch-browse-med-image" style="display: none;">
                                    <a class="jobsearch-rem-media-b" data-id="ad-image"><i class="dashicons dashicons-no-alt"></i></a>
                                    <img id="ad-image-img" src="" alt="">
                                </div>
                                <input type="hidden" id="ad-image">
                                <input type="button" class="jobsearch-upload-media jobsearch-bk-btn" name="ad-image" value="<?php esc_html_e('Browse', 'wp-jobsearch') ?>"> 
                            </div>
                        </div>
                        <div id="ad-banner-img-url-field" class="ad-banner-field-con ads-input-field">
                            <div class="field-label"><?php esc_html_e('Image URL', 'wp-jobsearch') ?></div>
                            <div class="field-value">
                                <input type="text" id="ad-img-url">
                            </div>
                        </div>
                        <div id="ad-banner-url-target-field" class="ad-banner-field-con ads-input-field">
                        ...
                        <div id="ad-banner-adsense-field" class="ad-banner-field-con ads-textarea-field" style="display:none;">
                            <div class="field-label"><?php esc_html_e('Adsense Code', 'wp-jobsearch') ?></div>
                            <div class="field-value">
                                <textarea id="ad-adsense-code"></textarea>
                            </div>
                        </div>
                        <div class="ad-banner-field-con ads-submit-field">
                            <div class="submit-btn">
                    ...
                    <div class="ad-banners-list-sec">
                        <div class="ad-item ad-head">
                            <ul>
                                ...
                                <li class="ad-code"><?php esc_html_e('Code', 'wp-jobsearch') ?></li>
                                <li>&nbsp;</li>
                            </ul>
                        </div>
                        <?php
                            ...
                            foreach ($field_value['banner_title'] as $banner_title) {
                                ...
                                <div class="ad-item">
                                    <ul>
                                        ...
                                        <li class="ad-code"><?php echo ('[jobsearch_ad code="' . $banner_code . '"]') ?></li>
                                        <li>
                                            <div class="action-btns">
                                    ...
                                    <div class="action-update-con">
                                        ...
                                        <div class="ad-banner-field-con ads-select-field">
                                            <div class="field-label"><?php esc_html_e('Banner Type', 'wp-jobsearch') ?></div>
                                            <div class="field-value">
                                                <select class="jobsearch-ad-type-select" name="<?php echo ($option_name) . '[banner_type][]' ?>" data-id="<?php echo ($banner_code) ?>">
                                        ...
                                        <div id="ad-banner-img-field-<?php echo ($banner_code) ?>" class="ad-banner-field-con ads-input-field" style="display: <?php echo ($banner_type == 'image' ? 'block' : 'none') ?>;">
                                            <div class="field-label"><?php esc_html_e('Banner Image', 'wp-jobsearch') ?></div>
                                            <div class="field-value">
                                                <div id="ad-image-<?php echo ($banner_code) ?>-box" class="jobsearch-browse-med-image" style="display: <?php echo ($banner_img != '' ? 'block' : 'none') ?>;">
                                                    <a class="jobsearch-rem-media-b" data-id="ad-image-<?php echo ($banner_code) ?>"><i class="dashicons dashicons-no-alt"></i></a>
                                                    <img id="ad-image-<?php echo ($banner_code) ?>-img" src="<?php echo ($banner_img) ?>" alt="">
                                                </div>
                                                <input type="hidden" id="ad-image-<?php echo ($banner_code) ?>" name="<?php echo ($option_name) . '[banner_image][]' ?>" value="<?php echo ($banner_img) ?>">
                                                <input type="button" class="jobsearch-upload-media jobsearch-bk-btn" name="ad-image-<?php echo ($banner_code) ?>" value="<?php esc_html_e('Browse', 'wp-jobsearch') ?>"> 
                                            </div>
                                        </div>
                                        <div id="ad-banner-img-url-field-<?php echo ($banner_code) ?>" class="ad-banner-field-con ads-input-field" style="display: <?php echo ($banner_type == 'image' ? 'block' : 'none') ?>;">
                                            <div class="field-label"><?php esc_html_e('Image URL', 'wp-jobsearch') ?></div>
                                            <div class="field-value">
                                                <input type="text" name="<?php echo ($option_name) . '[banner_img_url][]' ?>" value="<?php echo ($banner_img_url) ?>">
                                            </div>
                                        </div>
                                        <div id="ad-banner-url-target-field-<?php echo ($banner_code) ?>" class="ad-banner-field-con ads-input-field" style="display: <?php echo ($banner_type == 'image' ? 'block' : 'none') ?>;">
                                            <div class="field-label"><?php esc_html_e('URL Target', 'wp-jobsearch') ?></div>
                                            <div class="field-value">
                                        ...
                                        <div id="ad-banner-adsense-field-<?php echo ($banner_code) ?>" class="ad-banner-field-con ads-textarea-field" style="display: <?php echo ($banner_type == 'adsense' ? 'block' : 'none') ?>;">
                                            <div class="field-label"><?php esc_html_e('Adsense Code', 'wp-jobsearch') ?></div>
                                            <div class="field-value">
