    ...
    if ($pkgs_query->have_posts()) {
        ...
        <div class="jobsearch-row">
            ...
            while ($pkgs_query->have_posts()) : $pkgs_query->the_post();
                ...
                $num_of_cvs = get_post_meta($pkg_id, 'jobsearch_field_num_of_cvs', true);

                if ($packages_type == 'job') {
                    $num_of_jobs = get_post_meta($pkg_id, 'jobsearch_field_num_of_jobs', true);
                } else if ($packages_type == 'candidate') {
                    $num_of_apps = get_post_meta($pkg_id, 'jobsearch_field_num_of_apps', true);
                }
                    ...
                    <div class="jobsearch-classic-priceplane">
                        ...
                        <div class="grab-classic-priceplane">
                            ...
                            <?php if (is_user_logged_in()) { ?>
                                ...
                                ?>
                                <span class="pkg-loding-msg"></span>
                            <?php } else { ?>
