    ...
    public function social_login_api_settings($section_settings = array()) {
        if (isset($section_settings['fields'])) {
            ...
            $section_settings['fields'][] = array(
                ...
                'subtitle' => __('Please enter Client ID of your Google account.', 'wp-jobsearch'),
                'desc' => '',
                'default' => ''
            );
            ...
            $section_settings['fields'][] = array(
                ...
                'subtitle' => __('Please enter Client secret of your Google account.', 'wp-jobsearch'),
                'desc' => '',
                'default' => ''
            );
            ...
            $section_settings['fields'][] = array(
                ...
                'subtitle' => __('Please enter App ID of your Facebook account.', 'wp-jobsearch'),
                'desc' => '',
                'default' => ''
            );
            ...
            $section_settings['fields'][] = array(
                ...
                'subtitle' => __('Please enter App Secret of your Facebook account.', 'wp-jobsearch'),
                'desc' => '',
                'default' => ''
            );
            ...
            $section_settings['fields'][] = array(
                ...
                'transparent' => false,
                'title' => __('Client ID', 'wp-jobsearch'),
                'subtitle' => __('Please enter Client ID of your linkedin app.', 'wp-jobsearch'),
                'desc' => '',
                'default' => ''
            );
            $section_settings['fields'][] = array(
                ...
                'transparent' => false,
                'title' => __('Client Secret', 'wp-jobsearch'),
                'subtitle' => __('Please enter Client Secret of your linkedin app.', 'wp-jobsearch'),
                'desc' => '',
                'default' => ''
            );
        }
            ...
            if ($facebook_login == 'on' || $twitter_login == 'on' || $google_login == 'on' || $linkedin_login == 'on') {
                if (isset($args['type']) && $args['type'] == 'popup') {
                    ...
                    <div class="jobsearch-login-with">
                        <span><?php _e('or login with:', 'wp-jobsearch') ?></span>
                        <ul>
                            <?php
                            if ($facebook_login == 'on') {
                                echo do_shortcode('[jobsearch_facebook_login]');
