...
<div class="jobsearch-plugin-default-container" <?php echo force_balance_tags($plugin_default_view_with_str); ?>>
    <?php
    echo do_shortcode('[jobsearch_login_registration login_registration_title="' . esc_html__('User Login', 'wp-jobsearch') . '" login_register_form="' . $op_register_form_allow . '" login_candidate_register="' . $op_cand_register_allow . '" login_employer_register="' . $op_emp_register_allow . '"]');
    ?>
</div>
<?php
get_footer();
