    ...
    <div class="jobsearch-employer-dasboard">
        <div class="jobsearch-employer-box-section">
            <div class="jobsearch-profile-title">
                <h2><?php esc_html_e('Shortlisted Resumes', 'wp-jobsearch') ?></h2>
            </div>
            <?php
                    ...
                    <div class="jobsearch-employer-resumes">
                        <ul class="jobsearch-row">
                            ...
                            foreach ($employer_resumes_list as $candidate_id) {
                                ...
                                $user_def_avatar_url = get_avatar_url($candidate_user_id, array('size' => 48));
                                                ...
                                                <h2>
                                                    ...
                                                    if ($multiple_cv_files_allow == 'on') {
                                                        ...
                                                        if (!empty($ca_at_cv_files)) {
                                                            ?>
                                                            <a href="<?php echo apply_filters('jobsearch_user_attach_cv_file_url', '', $candidate_id, 0) ?>" download="<?php echo apply_filters('jobsearch_user_attach_cv_file_title', '', $candidate_id, 0) ?>" class="jobsearch-resumes-download"><i class="jobsearch-icon jobsearch-download-arrow"></i> <?php esc_html_e('Download CV', 'wp-jobsearch') ?></a>
                                                            <?php
                                                        }
                                                        ...
                                                        ?>
                                                        <a href="<?php echo ($file_url) ?>" download="<?php echo ($cv_file_title) ?>" class="jobsearch-resumes-download"><i class="jobsearch-icon jobsearch-download-arrow"></i> <?php esc_html_e('Download CV', 'wp-jobsearch') ?></a>
                                                        <?php
                                                    }
                                                    ?>
                                                </h2>
