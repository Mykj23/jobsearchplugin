                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" style="background-color: #454545; color: #f1f1f1; -webkit-border-top-left-radius: 6px !important; -webkit-border-top-right-radius: 6px !important; border-top-left-radius: 6px !important; border-top-right-radius: 6px !important; border-bottom: 0; font-family: Arial; font-weight: bold; line-height: 100%; vertical-align: middle;" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="color: #f1f1f1; margin: 0; padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">Request Change Password</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hi {username} ,
                                                            ...
                                                            This notice confirms that your password change request received . If you did not request  to change your password, please contact the Site Administrator at {ADMIN_EMAIL} - Admin Email This email has been sent to {user_email}    All at {SITE_NAME} .

                                                            Please Follow below to reset your password click on reset password below  to chnage your password.

                                                            <a href="http://{reset_password_link}"><strong>Reset Password</strong> </a>
                                                            <table class="blueTable">
                                                                <thead>
                                                                    <tr>
                                                                        <th style="text-align: center;" colspan="2">request change password</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
