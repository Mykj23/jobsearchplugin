...
?>
<div class="jobsearch-employer jobsearch-employer-list" id="jobsearch-employer-<?php echo absint($employer_short_counter) ?>">
                    ...
                    <div class="jobsearch-table-layer">
                        <div class="jobsearch-table-row">
                            ...
                            <div class="jobsearch-table-cell">
                                ...
                                <?php
                                if (!empty($get_employer_location)) {
                                    ?>
                            ...
                            if ($jobsearch_employer_job_count > 0) {
                                ?>
                                <div class="jobsearch-table-cell"> <a href="<?php echo esc_url(get_permalink($employer_id)); ?>" class="jobsearch-employer-list-btn"><?php echo esc_html($jobsearch_employer_job_count_str); ?> </a> </div>
                                <?php
                            }
                            ?>
                        </div>
